...
SECRET_KEY = '4o%q00!f37py3v7^r1ts^fzk@ay36ga9cd1^i9_(7o&n6uj-=!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['10.0.75.1','127.0.0.1','.pythonanywhere.com']
...
DATABASES = {
    'default': {
        ...
        'USER':'stewarthaha',
        'PASSWORD':'rlaclWkd',
        'HOST':'stewarthaha.mysql.pythonanywhere-services.com',
        'PORT':'3306',
